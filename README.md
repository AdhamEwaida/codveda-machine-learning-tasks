...
9. **TensorFlow/Keras neural network:** trains a feed-forward network for handwritten-digit classification, evaluates held-out accuracy, and visualizes training and validation performance.
